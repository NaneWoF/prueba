...
document.addEventListener("DOMContentLoaded", function() {
  ...
  qs("#register-form").onsubmit = async e => {
    ...
    try {
      ...
      await auth.signOut(); // Espera verificación
  ...
  // --- LOGIN (autenticación + verificación email) ---
  ...
  // --- Monitor auth state (con verificación de email) ---
  ...
  // --- Panel usuario (sincroniza en tiempo real salida) ---
  ...
  // --- Panel admin (sincroniza en tiempo real dispositivo) ---
  ...
  // --- Actualiza datos usuario (nombre, dirección) ---
